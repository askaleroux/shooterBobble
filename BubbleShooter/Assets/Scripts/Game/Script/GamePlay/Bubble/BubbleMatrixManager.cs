...
namespace Hanswu.bubble
{
    public class BubbleMatrixManager : MonoBehaviour
    {
        ...
        public static BubbleMatrixManager GetInstance(BubbleMatrix matrix, BubbleMatrixGeoInfo geoInfo)
        {
            if (_instance == null)
            {
                _instance = new BubbleMatrixManager(matrix, geoInfo);
            }
            return _instance;  
        }

        private BubbleMatrixManager(BubbleMatrix matrix, BubbleMatrixGeoInfo geoInfo)
        {
            _matrix = matrix;
            _geoInfo = geoInfo;
        }
